        ...
        >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-2xl">
              ...
              <button className="px-10 py-3 rounded-sm text-gray-200 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 hover:bg-[#be2222] shadow-lg shadow-white/50 bg-[#e82a2a] font-semibold">Get Started</button>
            </div>
          </div>
        </div>
      </div>
